...
int main()
{
    ...
    //vector <float> basis1 = {0.25,-0.5,0.75};
    ...
    for (int q= 0 ; q< num_temp_tets;q++)
    {
        ...
        int nearest_index = binary_search (reference1.data,query_projected1[q], 0, num_ref_points);
        exact_knn_projected_(&result_test,&reference1,query.row_data[q],query_projected1[q], nearest_index, test_k, q,num_ref_points, bucket_size);
